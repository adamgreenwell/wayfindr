            ...
            <section class="section" aria-labelledby="presence-settings-heading">
                ...
                @if ($canUpdatePrivacy)
                    <form class="section-form" method="POST" action="{{ route('dashboard.sites.presence.update', $site) }}">
                        ...
                        <p class="field-help">
                            With this on, the widget reports every {{ $presenceEvery }} seconds that somebody is on the site, and which page they are on. Visitors are told in the widget and can decline. Addresses are stored without query strings, and a visitor who never makes contact is deleted {{ $presenceRetentionDays }} {{ Str::plural('day', $presenceRetentionDays) }} after they were last seen.
                        </p>
