...
test('every catalogue file answers the same set of keys', function (): void {
    ...
    $expectedCognates = [
        ...
        'conversations.detail.roles.integration = Integration',
        ...
        'ticket_detail.common.integration = Integration',
        'ticket_detail.common.integration_actor = Integration · :name',
        ...
        'account_audit.references.integration = Integration',
