...
return [
    ...
    'readiness_cards' => [
        ...
        'email_paused' => 'Pausiert',
        'email_paused_detail' => 'Der Ruhemodus unterdrückt E-Mail-Benachrichtigungen, bis der Ruhemodus ausgeschaltet wird.',
        'email_quiet_hours_detail' => 'Die Ruhezeiten sind aktiv. E-Mail-Benachrichtigungen werden nach dem Ende des Ruhefensters fortgesetzt.',
        ...
        'push_quiet_hours_detail' => 'Die Ruhezeiten sind aktiv. Benachrichtigungen bei geschlossenem Dashboard werden nach dem Ende des Ruhefensters fortgesetzt.',
        ...
        'quiet_hours_label' => 'Ruhezeiten',
        'quiet_hours_off' => 'Aus',
        'quiet_hours_off_detail' => 'Töne, Web-Push und E-Mail-Zustellung können jederzeit ausgeführt werden.',
        'quiet_hours_active' => 'Jetzt aktiv',
        'quiet_hours_scheduled' => 'Geplant',
        'quiet_hours_detail' => 'Töne, Web-Push und E-Mail pausieren von :start bis :end in :timezone. Dashboard-Benachrichtigungen werden weiterhin gesammelt.',
    ],
    ...
    'alerts' => [
        ...
        'quiet_hours_enabled' => 'Unterbrechende Benachrichtigungen täglich pausieren',
        'quiet_hours_start' => 'Beginn',
        'quiet_hours_end' => 'Ende',
        'quiet_hours_help' => 'Töne, Web-Push und E-Mail pausieren in diesem Zeitfenster in :timezone. Zeitfenster über Mitternacht bis zu 22 Stunden werden unterstützt; Dashboard-Benachrichtigungen werden weiterhin gesammelt.',
        'quiet_hours_same' => 'Beginn und Ende der Ruhezeiten müssen unterschiedlich sein.',
        'quiet_hours_too_long' => 'Ruhezeiten dürfen nicht länger als 22 Stunden sein.',
