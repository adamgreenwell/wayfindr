...
return [
    ...
    'detail' => [
        ...
        'ticket_copilot' => [
            ...
            'suggested' => 'Vorschlag',
            'lede' => 'Erzeugen Sie aus dieser Unterhaltung einen Titel und eine Priorität. Vorhandene Labels werden lokal abgeglichen.',
            'generate' => 'Ticketdetails vorschlagen',
            'regenerate' => 'Vorschlag aktualisieren',
            'retry' => 'Vorschlag erneut versuchen',
            'use' => 'Vorgeschlagene Details verwenden',
            'pending' => 'Ein Vorschlag wird vorbereitet …',
            'pending_detail' => 'Die Anfrage befindet sich in der Warteschlange. Dieser Bereich wird aktualisiert, sobald die Ticketdetails bereit sind.',
            'generated' => 'Erzeugt :elapsed.',
            'source_count' => '{1} Basiert auf 1 Textnachricht.|[2,*] Basiert auf :count Textnachrichten.',
            'title' => 'Titel',
            'priority' => 'Priorität',
            'labels' => 'Labels',
            'no_labels' => 'Keine passenden vorhandenen Labels.',
            'stale' => 'Nach diesem Vorschlag sind neue Nachrichten eingegangen.',
            'stale_detail' => 'Aktualisieren Sie den Vorschlag vor der Übernahme in das Ticketformular.',
            'failed' => 'Die Ticketdetails konnten nicht vorgeschlagen werden.',
            'failed_detail' => 'Es wurden weder ein Ticket noch eine Unterhaltung geändert. Sie können es erneut versuchen.',
            'used' => 'Vorgeschlagene Details übernommen. Prüfen Sie sie vor dem Erstellen des Tickets.',
            'use_blocked' => 'Ihre aktuellen Ticketänderungen wurden beibehalten. Aktualisieren Sie die Seite, bevor Sie sie durch den Vorschlag ersetzen.',
            'use_stale' => 'Dieser Vorschlag muss vor der Verwendung aktualisiert werden.',
            'privacy' => 'Nur begrenzter Betreff- und Nachrichtentext wird nach Entfernung gängiger sensibler Muster gesendet. Profile, Metadaten, Anhänge, Cobrowse-Daten und der Labelkatalog des Kontos werden ausgelassen. Labels werden lokal abgeglichen. Erst nachdem Sie die Angaben geprüft und das Ticket erstellt haben, ändert sich etwas.',
        ],
        ...
        'ticket' => [
            ...
            'priority' => 'Priorität',
            'labels' => 'Labels',
            'labels_help' => 'Wählen Sie vorhandene Konto-Labels aus, die beim Erstellen des Tickets hinzugefügt werden sollen.',
    ...
    'validation' => [
        ...
        'ticket_labels' => 'Wählen Sie Labels aus, die weiterhin zu diesem Konto gehören.',
    ],
    ...
    'flash' => [
        ...
        'ai_ticket_suggestion_queued' => 'Ticketvorschlag zur Verarbeitung eingereiht.',
        'ai_ticket_suggestion_pending' => 'Ein Ticketvorschlag wird bereits vorbereitet.',
        'ai_ticket_suggestion_failed' => 'Der Ticketvorschlag konnte nicht zur Verarbeitung eingereiht werden. Versuchen Sie es erneut.',
