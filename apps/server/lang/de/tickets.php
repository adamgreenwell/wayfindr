...
return [
    ...
    'bulk' => [
        'region' => 'Sammelaktionen für Tickets',
        'action_label' => 'Aktion',
        'choose_action' => 'Aktion auswählen',
        'review' => 'Änderungen prüfen',
        'clear' => 'Auswahl aufheben',
        'select_all' => 'Alle sichtbaren Tickets auswählen',
        'select_ticket' => 'Ticket auswählen: :subject',
        'selected' => [
            'none' => 'Keine Tickets ausgewählt',
            'one' => '1 Ticket ausgewählt',
            'many' => ':count Tickets ausgewählt',
        ],
        'actions' => [
        ...
        'values' => [
            ...
            'choose_label' => 'Label auswählen',
            'choose_priority' => 'Priorität auswählen',
            'choose_status' => 'Status auswählen',
            'not_applied' => 'Nicht angewendet',
        ],
        'confirm' => [
            'document_title' => 'Sammeländerungen an Tickets prüfen',
            'title' => 'Sammeländerungen prüfen',
            'subtitle' => 'Prüfen Sie das genaue Ergebnis von: :action.',
            'heading' => 'Tickets in dieser Änderung',
            'summary' => 'Ausgewählt: :selected. Änderungen: :changed.',
            'undo_note' => 'Rückgängig stellt nur diese direkte Änderung wieder her. Wenn danach jemand dasselbe Feld bearbeitet, überspringt Wayfindr dieses Ticket, statt neuere Arbeit zu überschreiben.',
            'before' => 'Vorher',
            'after' => 'Nachher',
            'result' => 'Ergebnis',
            'will_change' => 'Wird geändert',
            'no_change' => 'Keine Änderung',
            'apply' => '{1} Auf 1 Ticket anwenden|[2,*] Auf :count Tickets anwenden',
            'cancel' => 'Zurück zur Ticketwarteschlange',
        ],
        'undo' => [
        ...
        'errors' => [
            ...
            'assignee_unavailable' => 'Dieser Agent kann nicht alle ausgewählten Tickets bearbeiten.',
            'label_unavailable' => 'Dieses Label ist nicht mehr verfügbar.',
            'preview_expired' => 'Diese Prüfung ist abgelaufen oder wurde bereits verwendet. Wählen Sie die Tickets aus und prüfen Sie die Aktion erneut.',
            'preview_stale' => 'Mindestens ein Ticket wurde nach der Prüfung geändert. Es wurde nichts angewendet. Prüfen Sie die aktuellen Werte und versuchen Sie es erneut.',
            'nothing_to_change' => 'Diese Tickets haben diesen Wert bereits. Es wurde nichts angewendet.',
