...
return [
    ...
    'tester' => [
        'document_title' => 'Pagina di prova del sito',
        'title' => 'Pagina di prova di :site',
        'subtitle' => 'Pagina di esempio ospitata per verificare il widget, il ciclo della chat e la mascheratura del cobrowse di questo sito.',
        'back' => 'Torna alle impostazioni del sito',
        'context' => [
            'heading' => 'Ambiente di prova',
            'lede' => 'Installazione del widget specifica del sito',
            'site' => 'Sito',
            'domain' => 'Dominio',
            'not_set' => 'Non impostato',
            'public_key' => 'Chiave pubblica',
            'visitor' => 'Visitatore di prova',
            'inbox' => 'Posta in arrivo',
            'open_conversations' => 'Apri conversazioni',
        ],
        'run' => [
            'heading' => 'Esecuzione di verifica',
            'lede' => 'Ciclo dal widget all’agente',
            'widget' => 'Widget integrato',
            'launcher' => 'Pulsante di apertura nell’angolo inferiore',
            'agent_view' => 'Vista agente',
            'conversations' => 'Conversazioni',
            'cobrowse' => 'Esempio di cobrowse',
            'masked_fields' => 'Campi fittizi mascherati',
        ],
        'sample' => [
            'heading' => 'Pagina di esempio',
            'lede' => 'Solo dati fittizi sicuri',
            'detail' => 'Contesto di assistenza comune con campi sensibili fittizi per verificare il percorso della privacy.',
            'current_task' => 'Attività corrente',
            'install_verification' => 'Verifica dell’installazione',
            'example_route' => 'Percorso di esempio',
            'safe_context' => 'Contesto sicuro',
            'form_aria' => 'Modulo di pagamento fittizio',
            'email' => 'Indirizzo email',
            'password' => 'Password',
            'card_number' => 'Numero della carta',
            'support_note' => 'Nota per l’assistenza',
        ],
    ],
];
