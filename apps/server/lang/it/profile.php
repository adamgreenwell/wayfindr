...
return [
    ...
    'alerts' => [
        ...
        'cadence_help' => 'La consegna del riepilogo raggruppa le email di avviso idonee quando viene eseguito il pianificatore. Le email unattended vengono inviate solo quando un messaggio di un visitatore resta non visualizzato. Gli avvisi della dashboard restano immediati.',
    ...
    'digest' => [
        ...
        'never_message' => 'Nessuna esecuzione del digest è stata ancora registrata.',
