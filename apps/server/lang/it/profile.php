...
return [
    ...
    'alerts' => [
        ...
        'push_storage_incompatible' => 'Le iscrizioni dei browser devono usare il database principale di Wayfindr prima che Web Push possa essere modificato in sicurezza.',
