...
/*
 * Drafted from lang/en/profile.php.
...
return [
    ...
    'readiness_cards' => [
        ...
        'email_paused' => 'In pausa',
        'email_paused_detail' => 'La modalità silenziosa sospende gli avvisi email finché non viene disattivata.',
        'email_quiet_hours_detail' => 'Le ore silenziose sono attive; gli avvisi email riprenderanno al termine dell’intervallo.',
        ...
        'push_quiet_hours_detail' => 'Le ore silenziose sono attive; gli avvisi a dashboard chiusa riprenderanno al termine dell’intervallo.',
        ...
        'quiet_hours_label' => 'Ore silenziose',
        'quiet_hours_off' => 'Disattivate',
        'quiet_hours_off_detail' => 'Suoni, Web Push e consegna email possono essere eseguiti in qualsiasi momento.',
        'quiet_hours_active' => 'Attive ora',
        'quiet_hours_scheduled' => 'Programmate',
        'quiet_hours_detail' => 'Suoni, Web Push ed email sono sospesi dalle :start alle :end in :timezone. Gli avvisi della dashboard continuano a essere raccolti.',
    ],
    'alerts' => [
        ...
        'quiet_hours_enabled' => 'Sospendi ogni giorno gli avvisi che interrompono',
        'quiet_hours_start' => 'Inizio',
        'quiet_hours_end' => 'Fine',
        'quiet_hours_help' => 'Suoni, Web Push ed email sono sospesi durante questo intervallo in :timezone. Sono supportati gli intervalli oltre la mezzanotte fino a 22 ore; gli avvisi della dashboard continuano a essere raccolti.',
        'quiet_hours_same' => 'L’ora di inizio e quella di fine devono essere diverse.',
        'quiet_hours_too_long' => 'Le ore silenziose non possono superare le 22 ore.',
