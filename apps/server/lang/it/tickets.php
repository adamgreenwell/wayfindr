...
return [
    ...
    'bulk' => [
        'region' => 'Azioni collettive sui ticket',
        'action_label' => 'Azione',
        'choose_action' => 'Scegli un\'azione',
        'review' => 'Rivedi le modifiche',
        'clear' => 'Cancella la selezione',
        'select_all' => 'Seleziona tutti i ticket visibili',
        'select_ticket' => 'Seleziona il ticket: :subject',
        'selected' => [
            'none' => 'Nessun ticket selezionato',
            'one' => '1 ticket selezionato',
            'many' => ':count ticket selezionati',
        ],
        'actions' => [
            'assign_agent' => 'Assegna un agente',
            'add_label' => 'Aggiungi un\'etichetta',
            'set_priority' => 'Imposta la priorità',
            'set_status' => 'Imposta lo stato',
            'close' => 'Chiudi i ticket',
        ],
        'values' => [
            'agent' => 'Agente',
            'label' => 'Etichetta',
            ...
            'choose_label' => 'Scegli un\'etichetta',
            'choose_priority' => 'Scegli una priorità',
            'choose_status' => 'Scegli uno stato',
            'not_applied' => 'Non applicata',
        ],
        'confirm' => [
            'document_title' => 'Revisione delle modifiche collettive ai ticket',
            'title' => 'Rivedi le modifiche collettive',
            'subtitle' => 'Confermi il risultato esatto di: :action.',
            'heading' => 'Ticket inclusi nella modifica',
            'summary' => 'Selezionati: :selected. Modifiche: :changed.',
            'undo_note' => 'L\'annullamento ripristina soltanto questa modifica diretta. Se in seguito qualcuno modifica lo stesso campo, Wayfindr salta quel ticket invece di sovrascrivere il lavoro più recente.',
            'before' => 'Prima',
            'after' => 'Dopo',
            'result' => 'Risultato',
            'will_change' => 'Verrà modificato',
            'no_change' => 'Nessuna modifica',
            'apply' => '{1} Applica a 1 ticket|[2,*] Applica a :count ticket',
            'cancel' => 'Torna alla coda dei ticket',
        ],
        'undo' => [
            'submit' => 'Annulla questa azione collettiva',
        ],
        'flash' => [
            'applied' => 'Azione collettiva applicata. Selezionati: :selected. Modificati: :changed.',
            'undone' => 'Azione collettiva annullata. Ripristinati: :reverted. Saltati perché è stato rilevato lavoro più recente: :skipped.',
        ],
        'errors' => [
            'value_required' => 'Scelga un valore per questa azione collettiva.',
            'value_invalid' => 'Questo valore non è disponibile per l\'azione collettiva.',
            'assignee_unavailable' => 'Questo agente non può gestire tutti i ticket selezionati.',
            'label_unavailable' => 'Questa etichetta non è più disponibile.',
            'preview_expired' => 'Questa revisione è scaduta o è già stata usata. Selezioni i ticket e riveda di nuovo l\'azione.',
            'preview_stale' => 'Uno o più ticket sono cambiati dopo la revisione. Non è stato applicato nulla; riveda i valori attuali e riprovi.',
            'nothing_to_change' => 'Questi ticket hanno già questo valore. Non è stato applicato nulla.',
    ...
    'next_action' => [
        ...
        'needs_agent' => [
            ...
            'body' => 'Questo ticket è assegnato ed è pronto per un aggiornamento da parte di un agente. Aggiunga una risposta, una nota interna o una modifica di stato.',
            'cta' => 'Rivedi azioni',
        ],
    ],
    'status_readiness' => [
    ...
    'row' => [
        ...
        'description_needs_owner' => 'Assegni questo ticket per farlo avanzare.',
