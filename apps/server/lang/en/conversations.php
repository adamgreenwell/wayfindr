...
return [
    ...
    'detail' => [
        ...
        'ticket_copilot' => [
            ...
            'suggested' => 'Suggested',
            'lede' => 'Generate a title and priority from this conversation. Existing labels are matched locally.',
            'generate' => 'Suggest ticket details',
            'regenerate' => 'Refresh suggestion',
            'retry' => 'Try suggestion again',
            'use' => 'Use suggested details',
            'pending' => 'Preparing a suggestion…',
            'pending_detail' => 'The request is queued. This panel updates when the ticket details are ready.',
            'generated' => 'Generated :elapsed.',
            'source_count' => '{1} Based on 1 text message.|[2,*] Based on :count text messages.',
            'title' => 'Title',
            'priority' => 'Priority',
            'labels' => 'Labels',
            'no_labels' => 'No matching existing labels.',
            'stale' => 'New messages arrived after this suggestion.',
            'stale_detail' => 'Refresh the suggestion before adding it to the ticket form.',
            'failed' => 'The ticket details could not be suggested.',
            'failed_detail' => 'No ticket or conversation changed. You can try again.',
            'used' => 'Suggested details added. Review them before creating the ticket.',
            'use_blocked' => 'Your current ticket edits were kept. Refresh the page before replacing them with the suggestion.',
            'use_stale' => 'Refresh this suggestion before using it.',
            'privacy' => 'Only bounded subject and message text are sent after common sensitive patterns are scrubbed. Profiles, metadata, attachments, cobrowse data, and the account label catalogue are omitted. Label matches happen locally. Nothing changes until you review and create the ticket.',
        ],
        ...
        'ticket' => [
            ...
            'priority' => 'Priority',
            'labels' => 'Labels',
            'labels_help' => 'Choose any existing account labels to add when the ticket is created.',
    ...
    'validation' => [
        ...
        'ticket_labels' => 'Choose labels that still belong to this account.',
    ],
    ...
    'flash' => [
        ...
        'ai_ticket_suggestion_queued' => 'Ticket suggestion queued.',
        'ai_ticket_suggestion_pending' => 'A ticket suggestion is already being prepared.',
        'ai_ticket_suggestion_failed' => 'The ticket suggestion could not be queued. Try again.',
