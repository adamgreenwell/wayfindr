...
return [
    ...
    'bulk' => [
        'region' => 'Bulk ticket actions',
        'action_label' => 'Action',
        'choose_action' => 'Choose an action',
        'review' => 'Review changes',
        'clear' => 'Clear selection',
        'select_all' => 'Select all visible tickets',
        'select_ticket' => 'Select ticket: :subject',
        'selected' => [
            'none' => 'No tickets selected',
            'one' => '1 ticket selected',
            'many' => ':count tickets selected',
        ],
        'actions' => [
        ...
        'confirm' => [
            'document_title' => 'Review bulk ticket changes',
            'title' => 'Review bulk changes',
            'subtitle' => 'Confirm the exact result of: :action.',
            'heading' => 'Tickets in this change',
            'summary' => 'Selected: :selected. Changes: :changed.',
            'undo_note' => 'Undo restores only this direct change. If somebody edits the same field afterward, Wayfindr skips that ticket instead of overwriting newer work.',
            'before' => 'Before',
            'after' => 'After',
            'result' => 'Result',
            'will_change' => 'Will change',
            'no_change' => 'No change',
            'apply' => '{1} Apply to 1 ticket|[2,*] Apply to :count tickets',
            'cancel' => 'Back to ticket queue',
        ],
        'undo' => [
        ...
        'errors' => [
            ...
            'assignee_unavailable' => 'That agent cannot work every selected ticket.',
            'label_unavailable' => 'That label is no longer available.',
            'preview_expired' => 'That review expired or was already used. Select the tickets and review the action again.',
            'preview_stale' => 'One or more tickets changed after the review. Nothing was applied; review the current values and try again.',
            'nothing_to_change' => 'Those tickets already have that value. Nothing was applied.',
