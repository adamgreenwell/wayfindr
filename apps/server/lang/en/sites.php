...
return [
    ...
    'tester' => [
        ...
        'context' => [
            ...
            'lede' => 'Site-scoped widget install',
            'site' => 'Site',
            'domain' => 'Domain',
            'not_set' => 'Not set',
            'public_key' => 'Public key',
            'visitor' => 'Tester visitor',
            'inbox' => 'Inbox',
            'open_conversations' => 'Open conversations',
        ],
        'run' => [
            'heading' => 'Verification run',
            'lede' => 'Widget to agent loop',
            'widget' => 'Widget',
            'launcher' => 'Lower-corner launcher',
            'agent_view' => 'Agent view',
            'conversations' => 'Conversations',
            'cobrowse' => 'Cobrowse sample',
            'masked_fields' => 'Masked fake fields',
        ],
        'sample' => [
            'heading' => 'Sample page',
            'lede' => 'Safe fake data only',
            'detail' => 'Common support context with fake sensitive fields for the privacy path.',
            'current_task' => 'Current task',
            'install_verification' => 'Install verification',
            'example_route' => 'Example route',
            'safe_context' => 'Safe context',
            'form_aria' => 'Fake checkout form',
            'email' => 'Email address',
            'password' => 'Password',
