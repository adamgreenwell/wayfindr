...
`DashboardLanguage::EXTRACTED_ROUTES` names **48 routes — 19 of them pages** a
...
directory and profile, and the operator's language-and-region and attachment-
scanning settings pages.
