...
- **Replies to visitors** — agent replies to a conversation that arrived by
  ...
  ([support-hours-and-intake.md](../product/support-hours-and-intake.md)). Both
  are skipped entirely while the mailer cannot deliver, and the agent is told
  so beside the conversation's reply box.
